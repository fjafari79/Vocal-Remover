...
def main():
    ...
    p.add_argument('--pretrained_model', '-P', type=str, default='C:/Fatemeh/Internship/PASS/code/vocal-remover/models/baseline.pth')
    #p.add_argument('--input', '-i', required=True)
    p.add_argument('--input', '-i', type=str, default="C:/Fatemeh/Internship/PASS/code/voice/KhooshehChin.mp3")
